      ...
      <div className="row">
        <div className="col-lg-12">
          <div className="section-title">
            <h2>Premium Room</h2> {/* Corrected typo: "premium" to "Premium" */}
          </div>
        </div>
      </div>
      <div className="container" style={{ marginTop: "-35px" }}>
        <div className="row">
          <div className="col-lg-6">
            <GalleryItem imageUrl={`${BASE_URL}${imageUrls[0]}`} title="Premium Room 1" />
            <div className="row">
              <div className="col-sm-6">
                <GalleryItem imageUrl={`${BASE_URL}${imageUrls[1]}`} title="Premium Room 2" />
              </div>
              <div className="col-sm-6">
                <GalleryItem imageUrl={`${BASE_URL}${imageUrls[2]}`} title="Premium Room 3" />
              </div>
            </div>
          </div>
          <div className="col-lg-6">
            <GalleryItem imageUrl={`${BASE_URL}${imageUrls[3]}`} title="Premium Room 4" />
            <div className="row">
              <div className="col-sm-12">
                <GalleryItem imageUrl={`${BASE_URL}${imageUrls[4]}`} title="Premium Room 5" />
              </div>
            </div>
          </div>
        </div>
