...
const ImageGallery = () => {
  ...
  useEffect(() => {
    const fetchImageUrls = async () => {
      try {
        const roomType = 'small'; // Change room type here
  ...
  useEffect(() => {
    const fetchStatus = async () => {
      try {
        const roomId = 6; // Replace with the actual room ID
        const roomType = 'small'; // Room type
          ...
          >
            ...
            <Dropdown className="mt-3">
              ...
              <Dropdown.Menu className="custom-dropdown-menu ml-2">
                ...
                <Link to={`/Admin/DeleteImage?roomType=small`}>
