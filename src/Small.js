      ...
      <div className="container" style={{ marginTop: "-35px" }}>
        <div className="row">
          <div className="col-lg-6">
            <GalleryItem imageUrl={`${BASE_URL}${imageUrls[0]}`} title="Small Room 1" />
            <div className="row">
              <div className="col-sm-6">
                <GalleryItem imageUrl={`${BASE_URL}${imageUrls[1]}`} title="Small Room 2" />
              </div>
              <div className="col-sm-6">
                <GalleryItem imageUrl={`${BASE_URL}${imageUrls[2]}`} title="Small Room 3" />
              </div>
            </div>
          </div>
          <div className="col-lg-6">
            <GalleryItem imageUrl={`${BASE_URL}${imageUrls[3]}`} title="Small Room 4" />
            <div className="row">
              <div className="col-sm-12">
                <GalleryItem imageUrl={`${BASE_URL}${imageUrls[4]}`} title="Small Room 5" />
              </div>
            </div>
          </div>
        </div>
